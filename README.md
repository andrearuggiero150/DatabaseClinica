<h1>Database clinica privata</h1>
</div>

## Descrizione
L'obiettivo del progetto è creare un database per la gestione dei ticket effettuati dai pazienti di una clinica privata consultabile attraverso una GUI dedicata.
